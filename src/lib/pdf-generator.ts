...
export function generatePdf(invoice: Invoice, userInfo: UserInfo): Promise<Blob | null>;
...
export function generatePdf(invoice: Invoice, userInfo: UserInfo, outputType: 'save' | 'blob' = 'save'): Promise<Blob | null> | void {
